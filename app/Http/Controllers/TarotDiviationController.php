...
class TarotDiviationController extends Controller
{
    public function show(){
        $tarotCards = [
            ...
            "/Молодші аркани/Кубки/Туз мечів.jpg" ,
    ...
    public function generateAnswer(Request $request)
    {
        ...
        $request = "Не говори нічого лишнього, окрім самого трактування. Використовуй виключно українську та серйозну мову мову. Дай повне тракнуваня розскдаду. Відповідь має бути повним, суцільним і цікавим тестом, обов'язково з висновком в кінці";
        if ($question) {
